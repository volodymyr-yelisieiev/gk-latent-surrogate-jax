...
accepted aggregate, figures, schemas, configs, tests, and sanitized release remain available from a
clean checkout; the 225-file W\&B-disabled status archive is retained in the local ignored evidence
workspace, while the release records its aggregate status and configuration verification. No
private stage payloads are required for audit.
