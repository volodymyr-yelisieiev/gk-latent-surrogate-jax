...
trained on that trajectory. These principles motivate the trajectory-level lineage checks and the
validation-then-locked-test protocol used in this thesis.
...
jitter, and sparse element masking. It does not use arbitrary crops or rotations. Moreover, the
